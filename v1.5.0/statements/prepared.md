...
In such cases use a [paged query](https://rust-driver.docs.scylladb.com/v1.5.0/statements/paged.md) instead.
...
Passing values and the result is the same as in [unprepared statement](https://rust-driver.docs.scylladb.com/v1.5.0/statements/unprepared.md).
