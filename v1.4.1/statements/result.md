...
> e.g. with `Session::query_iter()` (see [Paged queries](https://rust-driver.docs.scylladb.com/v1.4.1/statements/paged.md)).
...
It is possible to receive row as a struct with fields matching the columns.<br />
\\\\
The struct must:
...
For parsing other data types see [Data Types](https://rust-driver.docs.scylladb.com/v1.4.1/data-types/data-types.md)
