...
[Unprepared statement](https://rust-driver.docs.scylladb.com/v1.4.1/statements/unprepared.md), [prepared statement](https://rust-driver.docs.scylladb.com/v1.4.1/statements/prepared.md) and [batch statement](https://rust-driver.docs.scylladb.com/v1.4.1/statements/batch.md)
