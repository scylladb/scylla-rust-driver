...
#### WARNING
Don’t use `execute_unpaged` to receive large amounts of data.<br />
\\\\
Unpaged requests might cause heavy load on the cluster.
In reality, its almost always wrong to use unpaged SELECTs.

In such cases use a [paged query](https://rust-driver.docs.scylladb.com/v1.6.0/statements/paged.md) instead.
...
Passing values and the result is the same as in [unprepared statement](https://rust-driver.docs.scylladb.com/v1.6.0/statements/unprepared.md).
