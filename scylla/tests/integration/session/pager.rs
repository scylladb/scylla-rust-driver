...
async fn test_pager_consistency_reset_between_pages() {
    ...
    let res = test_with_3_node_cluster(
        ...
        |proxy_uris, translation_map, mut running_proxy| async move {
            ...
            // system_schema.keyspaces has ≥4 built-in keyspaces (system,
            // system_schema, system_auth, system_traces, …) on both ScyllaDB
            // and Cassandra, giving us at least pages 1–3 regardless of
