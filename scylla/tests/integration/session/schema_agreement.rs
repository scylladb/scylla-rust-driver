...
#[allow(dead_code)] // For now not tested. Runs the same underlying logic as SessionQueryAPI.
...
#[allow(dead_code)] // For now not tested. Runs the same underlying logic as PagerQueryIterAPI.
