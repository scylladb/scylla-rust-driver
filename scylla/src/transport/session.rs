...
impl std::fmt::Debug for Legacy08Session {
...
impl Legacy08Session {
    ...
    /// # }
    /// ```
    pub async fn connect(config: SessionConfig) -> Result<Legacy08Session, NewSessionError> {
