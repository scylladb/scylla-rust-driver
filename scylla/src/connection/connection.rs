...
/// the [`Session`](crate::session::Session) instance are not translated, only IP addresses
/// retrieved from or sent by Cassandra nodes to the driver are.
#[async_trait]
...
mod tests {
    ...
    async fn connection_is_closed_on_no_response_to_keepalives() {
        use crate::execution::errors::BrokenConnectionErrorKind;
