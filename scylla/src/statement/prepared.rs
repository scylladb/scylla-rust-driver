...
/// the statement and prepare it again. Note that insterting UDT values not containing the new field
...
impl PreparedStatement {
    ...
    /// For DBs that do (modern Scylla) this option is true, and can't be disabled.
