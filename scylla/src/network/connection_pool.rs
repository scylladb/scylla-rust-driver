...
impl PoolConfig {
    fn to_host_pool_config(&self) -> HostPoolConfig {
        HostPoolConfig {
            connection_config: self.connection_config.to_host_connection_config(),
...
impl NodeConnectionPool {
    pub(crate) fn new(
        ...
        let host_pool_config = pool_config.to_host_pool_config();
