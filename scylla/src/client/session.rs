...
impl Session {
    ...
    /// as SchemaNodeResult::Success.
    /// Otherwise:
    /// - Iff all connections returned ConnectionBrokenError, first such error will be returned,
    ///   as SchemaNodeResult::BrokenConnection.
    /// - If there is some other type of error on any connection, first such error will be returned as Err.
    ///
