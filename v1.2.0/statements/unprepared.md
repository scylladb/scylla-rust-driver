...
> \\\\
> In such cases use [paged query](https://rust-driver.docs.scylladb.com/v1.2.0/statements/paged.md) instead.\\
...
See [Query values](https://rust-driver.docs.scylladb.com/v1.2.0/statements/values.md) for more information about sending values in queries
...
See [Query result](https://rust-driver.docs.scylladb.com/v1.2.0/statements/result.md) for more information about handling query results

## Performance

Unprepared statements should not be used in places where performance matters.<br />
\\\\
If performance matters use a [Prepared statement](https://rust-driver.docs.scylladb.com/v1.2.0/statements/prepared.md) instead.
