...
On API level, `Session::query_iter` and `Session::execute_iter` take a [unprepared statement](https://rust-driver.docs.scylladb.com/v1.2.0/statements/unprepared.md)
or a [prepared statement](https://rust-driver.docs.scylladb.com/v1.2.0/statements/prepared.md), respectively, and return a `QueryPager`. `QueryPager` needs
...
Use `query_iter` to perform an [unprepared query](https://rust-driver.docs.scylladb.com/v1.2.0/statements/unprepared.md) with paging:
...
Use `execute_iter` to perform a [prepared query](https://rust-driver.docs.scylladb.com/v1.2.0/statements/prepared.md) with paging:
...
Statement values can be passed to `query_iter` and `execute_iter` just like in an [unprepared statement](https://rust-driver.docs.scylladb.com/v1.2.0/statements/unprepared.md)
...
For the best performance use [prepared statements](https://rust-driver.docs.scylladb.com/v1.2.0/statements/prepared.md).
See [statement types overview](https://rust-driver.docs.scylladb.com/v1.2.0/statements/statements.md).
