...
[Default Policy](https://rust-driver.docs.scylladb.com/v1.3.1/load-balancing/default-policy.md) for details), but you can
...
Our recommendation is to use [`Default Policy`](https://rust-driver.docs.scylladb.com/v1.3.1/load-balancing/default-policy.md) with token-
