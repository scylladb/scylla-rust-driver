...
> e.g. with `Session::query_iter()` (see [Paged queries](https://rust-driver.docs.scylladb.com/v1.3.1/statements/paged.md)).
...
For parsing other data types see [Data Types](https://rust-driver.docs.scylladb.com/v1.3.1/data-types/data-types.md)
