...
> must be sent as bound values (see [performance section]())
>  ***Warning***<br />
> \\\\
> Don’t use `execute` to receive large amounts of data.<br />
> \\\\
> By default the query is unpaged and might cause heavy load on the cluster.
> In such cases set a page size and use a [paged query](https://rust-driver.docs.scylladb.com/v1.3.1/statements/paged.md) instead.
...
Passing values and the result is the same as in [unprepared statement](https://rust-driver.docs.scylladb.com/v1.3.1/statements/unprepared.md).
