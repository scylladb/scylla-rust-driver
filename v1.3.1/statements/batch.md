...
\\\\
These statements can be [unprepared](https://rust-driver.docs.scylladb.com/v1.3.1/statements/unprepared.md) or [prepared](https://rust-driver.docs.scylladb.com/v1.3.1/statements/prepared.md).<br />
\\\\
...
Batch takes a tuple of values specified just like in [unprepared](https://rust-driver.docs.scylladb.com/v1.3.1/statements/unprepared.md) or [prepared](https://rust-driver.docs.scylladb.com/v1.3.1/statements/prepared.md) statements.
...
For more information about sending values in a statement see [Statement values](https://rust-driver.docs.scylladb.com/v1.3.1/statements/values.md)

## Performance

Batch statements do not use token/shard aware load balancing, batches are sent to a random node.

Use [prepared statements](https://rust-driver.docs.scylladb.com/v1.3.1/statements/prepared.md) for best performance
