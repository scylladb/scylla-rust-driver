...
impl Service<scylla::unprepared_statement::UnpreparedStatement> for SessionService {
    ...
    fn call(&mut self, req: scylla::unprepared_statement::UnpreparedStatement) -> Self::Future {
