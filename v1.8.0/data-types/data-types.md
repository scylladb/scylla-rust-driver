...
See [Statement values](https://rust-driver.docs.scylladb.com/v1.8.0/statements/values.md) for more information about sending values along with statements.<br />
\\\\
See [Query result](https://rust-driver.docs.scylladb.com/v1.8.0/statements/result.md) for more information about retrieving values from queries
