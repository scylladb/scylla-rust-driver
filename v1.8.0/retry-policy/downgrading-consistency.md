...
This policy implements the same retries than the [DefaultRetryPolicy](https://rust-driver.docs.scylladb.com/v1.8.0/retry-policy/default.md) policy. But on top
...
To use in an [unprepared statement](https://rust-driver.docs.scylladb.com/v1.8.0/statements/unprepared.md):
...
To use in a [prepared statement](https://rust-driver.docs.scylladb.com/v1.8.0/statements/prepared.md):
