...
> e.g. with `Session::query_iter()` (see [Paged queries](https://rust-driver.docs.scylladb.com/v1.8.0/statements/paged.md)).
...
For parsing other data types see [Data Types](https://rust-driver.docs.scylladb.com/v1.8.0/data-types/data-types.md)
