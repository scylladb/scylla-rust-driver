...
mod compression {
    ...
    impl CompressionWriter {
        ...
        pub(crate) fn set_from_startup(
            ...
            let maybe_compression = startup
                .options
                .get(scylla_cql::frame::request::options::COMPRESSION);
    ...
    impl CompressionReader {
        ...
        ///
        /// Outer Option signifies whether the negotiation took places,
    ...
    async fn proxy_reports_target_shard_as_feedback() {
        ...
        for shards_count in 2..9 {
            ...
            fn draw_source_port_for_shard(shards_count: u16, shard: u16) -> u16 {
                ...
                49152_u16.div_ceil(shards_count) * shards_count + shard
            }
