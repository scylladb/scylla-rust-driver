...
These statements can be [unprepared](https://rust-driver.docs.scylladb.com/stable/statements/unprepared.md) or [prepared](https://rust-driver.docs.scylladb.com/stable/statements/prepared.md).
