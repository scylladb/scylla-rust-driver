...
### [Unprepared](https://rust-driver.docs.scylladb.com/v1.3.0/statements/unprepared.md) vs [Prepared](https://rust-driver.docs.scylladb.com/v1.3.0/statements/prepared.md)
...
### Single vs [Batch](https://rust-driver.docs.scylladb.com/v1.3.0/statements/batch.md)
...
### [Paged](https://rust-driver.docs.scylladb.com/v1.3.0/statements/paged.md) vs Unpaged query

>  ***GOOD TO KNOW***<br />
> \\\\
> SELECT statements return a [result set](https://rust-driver.docs.scylladb.com/v1.3.0/statements/result.md), possibly a large one. Therefore, paging is available to fetch it in chunks, relieving load on cluster and lowering latency.<br />
> \\\\
>  ***Key take-overs:***<br />
> \\\\
...
| Usability               | get all results in a single CQL frame, so into a [single Rust struct](https://rust-driver.docs.scylladb.com/v1.3.0/statements/result.md) | need to fetch multiple CQL frames and iterate over them - using driver’s abstractions (`{query,execute}_iter`) or manually (`{query,execute}_single_page` in a loop) |
...
For more detailed comparison and more best practices, see [doc page about paging](https://rust-driver.docs.scylladb.com/v1.3.0/statements/paged.md).

### Queries are fully asynchronous - you can run as many of them in parallel as you wish

## `USE KEYSPACE`

There is a special functionality to enable [USE keyspace](https://rust-driver.docs.scylladb.com/v1.3.0/statements/usekeyspace.md).
