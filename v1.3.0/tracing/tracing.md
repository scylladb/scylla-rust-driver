...
* [`Session::query_unpaged()`](https://rust-driver.docs.scylladb.com/v1.3.0/tracing/basic.md)
* [`Session::query_iter()`](https://rust-driver.docs.scylladb.com/v1.3.0/tracing/paged.md)
* [`Session::execute_unpaged()`](https://rust-driver.docs.scylladb.com/v1.3.0/tracing/basic.md)
* [`Session::execute_iter()`](https://rust-driver.docs.scylladb.com/v1.3.0/tracing/paged.md)
* [`Session::batch()`](https://rust-driver.docs.scylladb.com/v1.3.0/tracing/basic.md)
* [`Session::prepare()`](https://rust-driver.docs.scylladb.com/v1.3.0/tracing/prepare.md)

After obtaining the tracing id you can use `Session::get_tracing_info()` to query tracing information.<br />
\\\\
`TracingInfo` contains values that are the same in Scylla and Cassandra®, skipping any database-specific ones.<br />
\\\\
...
More information is available in the [Query Execution History](https://rust-driver.docs.scylladb.com/v1.3.0/tracing/query-history.md) chapter.
