...
[Unprepared statement](https://rust-driver.docs.scylladb.com/v1.3.0/statements/unprepared.md), [prepared statement](https://rust-driver.docs.scylladb.com/v1.3.0/statements/prepared.md) and [batch statement](https://rust-driver.docs.scylladb.com/v1.3.0/statements/batch.md)
