...
1. The tablet’s Raft leader, for a leader-requiring request against a
   strongly-consistent table — see [Tablet awareness](https://rust-driver.docs.scylladb.com/main/load-balancing/tablets.md). This
...
Leader-aware routing (see [Tablet awareness](https://rust-driver.docs.scylladb.com/main/load-balancing/tablets.md)) is a separate
