...
[Default Policy](https://rust-driver.docs.scylladb.com/main/load-balancing/default-policy.md) for details), but you can
...
Our recommendation is to use [`Default Policy`](https://rust-driver.docs.scylladb.com/main/load-balancing/default-policy.md) with token-
