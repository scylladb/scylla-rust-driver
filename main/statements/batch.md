...
\\\\
These statements can be [unprepared](https://rust-driver.docs.scylladb.com/main/statements/unprepared.md) or [prepared](https://rust-driver.docs.scylladb.com/main/statements/prepared.md).<br />
\\\\
...
Batch takes a tuple of values specified just like in [unprepared](https://rust-driver.docs.scylladb.com/main/statements/unprepared.md) or [prepared](https://rust-driver.docs.scylladb.com/main/statements/prepared.md) statements.
...
For more information about sending values in a statement see [Statement values](https://rust-driver.docs.scylladb.com/main/statements/values.md)
...
its own partition. Use [prepared statements](https://rust-driver.docs.scylladb.com/main/statements/prepared.md) for best performance.
