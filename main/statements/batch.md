...
These statements can be [unprepared](https://rust-driver.docs.scylladb.com/main/statements/unprepared.md) or [prepared](https://rust-driver.docs.scylladb.com/main/statements/prepared.md).
