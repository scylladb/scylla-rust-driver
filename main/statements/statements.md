...
> SELECT statements return a [result set](https://rust-driver.docs.scylladb.com/main/statements/result.md), possibly a large one. Therefore, paging is available to fetch it in chunks, relieving load on cluster and lowering latency.
...
### [Bound](https://rust-driver.docs.scylladb.com/main/statements/bound.md) statements
...
to another layer that knows nothing about the values’ types. See [bound statement](https://rust-driver.docs.scylladb.com/main/statements/bound.md).
