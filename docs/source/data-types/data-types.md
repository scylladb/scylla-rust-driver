...
See [Statement values](../statements/values.md) for more information about sending values in queries.\
See [Query result](../statements/result.md) for more information about reading values from queries
