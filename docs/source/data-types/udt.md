...
ScyllaDB drivers often map Rust Enums to integer columns (`int`, `smallint`, `tinyint`). The driver macros support this via the `repr` attribute.
...
### Supported Types
You can use any standard Rust integer type: `i8`, `i16`, `i32`, `i64`, `u8`, etc.
