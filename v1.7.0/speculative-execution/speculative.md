...
* [Simple](https://rust-driver.docs.scylladb.com/stable/speculative-execution/simple.md)
* [Latency Percentile](https://rust-driver.docs.scylladb.com/stable/speculative-execution/percentile.md)
...
(see [Query idempotence](https://rust-driver.docs.scylladb.com/stable/retry-policy/retry-policy.md#query-idempotence)).
