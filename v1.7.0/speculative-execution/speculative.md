...
* [Simple](https://rust-driver.docs.scylladb.com/v1.7.0/speculative-execution/simple.md)
* [Latency Percentile](https://rust-driver.docs.scylladb.com/v1.7.0/speculative-execution/percentile.md)
...
(see [Query idempotence](https://rust-driver.docs.scylladb.com/v1.7.0/retry-policy/retry-policy.md#query-idempotence)).
