...
> e.g. with `Session::query_iter()` (see [Paged queries](https://rust-driver.docs.scylladb.com/stable/statements/paged.md)).
...
For parsing other data types see [Data Types](https://rust-driver.docs.scylladb.com/stable/data-types/data-types.md)
