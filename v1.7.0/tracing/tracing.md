...
* [`Session::query_unpaged()`](https://rust-driver.docs.scylladb.com/v1.7.0/tracing/basic.md)
* [`Session::query_iter()`](https://rust-driver.docs.scylladb.com/v1.7.0/tracing/paged.md)
* [`Session::execute_unpaged()`](https://rust-driver.docs.scylladb.com/v1.7.0/tracing/basic.md)
* [`Session::execute_iter()`](https://rust-driver.docs.scylladb.com/v1.7.0/tracing/paged.md)
* [`Session::batch()`](https://rust-driver.docs.scylladb.com/v1.7.0/tracing/basic.md)
* [`Session::prepare()`](https://rust-driver.docs.scylladb.com/v1.7.0/tracing/prepare.md)
...
More information is available in the [Query Execution History](https://rust-driver.docs.scylladb.com/v1.7.0/tracing/query-history.md) chapter.
