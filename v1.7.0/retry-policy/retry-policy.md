...
* [Fallthrough Retry Policy](https://rust-driver.docs.scylladb.com/stable/retry-policy/fallthrough.md) - never retries, returns all errors straight to the user
* [Default Retry Policy](https://rust-driver.docs.scylladb.com/stable/retry-policy/default.md) - used by default, might retry if there is a high chance of success
* [Downgrading Consistency Retry Policy](https://rust-driver.docs.scylladb.com/stable/retry-policy/downgrading-consistency.md) - behaves as [Default Retry Policy](https://rust-driver.docs.scylladb.com/stable/retry-policy/default.md), but also,
...
Retry policies and [speculative execution](https://rust-driver.docs.scylladb.com/stable/speculative-execution/speculative.md)
...
* **Retry policies** receive `is_idempotent` as one input on `RequestInfo`
  ...
  re-execution safe (for example, the [Default Retry Policy](https://rust-driver.docs.scylladb.com/stable/retry-policy/default.md)
