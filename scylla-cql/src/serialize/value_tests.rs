...
fn test_map_errors() {
    ...
    let err = do_serialize_err(v, &ColumnType::Native(NativeType::Double));
    let typeck_err = get_typeck_err(&err);
    assert_eq!(typeck_err.rust_name, std::any::type_name::<BTreeMap<&str, &str>>());
    assert_eq!(typeck_err.got, ColumnType::Native(NativeType::Double));
    assert_matches!(
        typeck_err.kind,
    ...
    let err = do_serialize_err(v, &typ);
    let ser_err = get_ser_err(&err);
    assert_eq!(ser_err.rust_name, std::any::type_name::<BTreeMap<i32, i32>>());
    assert_eq!(ser_err.got, typ);
...
fn test_tuple_errors() {
    ...
    let err = do_serialize_err(v, &ColumnType::Native(NativeType::Double));
    let typeck_err = get_typeck_err(&err);
    assert_eq!(typeck_err.rust_name, std::any::type_name::<(i32, i32, i32)>());
    assert_eq!(typeck_err.got, ColumnType::Native(NativeType::Double));
    assert_matches!(
        typeck_err.kind,
