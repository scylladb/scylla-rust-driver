...
use super::{BufBackedCellWriter, BufBackedRowWriter, CellWriter, RowWriter, SerializationError};
...
impl SerializedValues {
    ...
    #[allow(dead_code)]
    pub(crate) fn into_old_serialized_values(self) -> LegacySerializedValues {
