...
use super::request::query::{QueryParametersSerializationError, QuerySerializationError};
...
pub enum ParseError {
    ...
    QueryParametersSerializationError(#[from] QueryParametersSerializationError),
