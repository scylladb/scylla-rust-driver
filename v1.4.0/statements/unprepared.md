...
>  ***Warning***<br />
> \\\\
> Don’t use unprepared queries to receive large amounts of data.<br />
> \\\\
> By default the query is unpaged and might cause heavy load on the cluster.<br />
> \\\\
> In such cases use [paged query](https://rust-driver.docs.scylladb.com/v1.4.0/statements/paged.md) instead.\\
...
As the first argument `Session::query_unpaged` takes anything implementing `Into<Statement>`.<br />
\\\\
...
You can pass changing values to a statement by specifying a list of variables as bound values.<br />
\\\\
...
See [Query values](https://rust-driver.docs.scylladb.com/v1.4.0/statements/values.md) for more information about sending values in queries
...
See [Query result](https://rust-driver.docs.scylladb.com/v1.4.0/statements/result.md) for more information about handling query results

## Performance

Unprepared statements should not be used in places where performance matters.<br />
\\\\
If performance matters use a [Prepared statement](https://rust-driver.docs.scylladb.com/v1.4.0/statements/prepared.md) instead.
