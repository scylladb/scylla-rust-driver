...
> In such cases set a page size and use a [paged query](https://rust-driver.docs.scylladb.com/v1.4.0/statements/paged.md) instead.
...
Passing values and the result is the same as in [unprepared statement](https://rust-driver.docs.scylladb.com/v1.4.0/statements/unprepared.md).
